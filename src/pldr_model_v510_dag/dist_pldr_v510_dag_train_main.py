'''
Main script for distributed training of PLDR-LLM v510_dag
'''
...
import pldr_run_model_v510_dag as pldr_run_model
...
def fsdp_pldr_main(rank, world_size, args):
    ...
    DAG_reg_coeffs=args.DAG_reg_coeffs
...
if __name__ == '__main__':
    ...
    parser.add_argument('--DAG_reg_coeffs', type=float, nargs=3, default=[0, 0, 0], metavar='DAG_COEFF_LIST',
                    help='MODEL PARAM: Coeficients for DAG regularization (Default: 1e-3)')    
