''''
Power law attention implementation for PLDR-LLM v510_dag with pytorch and KV-cache and G-cache.
'''
...
class plga_layer(nn.Module):
    ...
    def cg_align_one(self, Hin, Hkt, A, a_vec, ba, W, b, pw, mask=None, Gcache=None):
        ...
        Args:
            ...
            Gcache: A list containing cache of [A_LM, G_LM, Ap]
        Returns:
            A list of:
        ...
        return E, [AW, pw, a_vec, ba, avAp, Ep, Ap]
