#!/bin/bash
#This module is provided for completeness since support for PLDR-LLM v510 is available
#within PLDR LLM v510Gi module.
#PLDR-LLM v510Gi is intended for inference in ablation studies.
...
declare -a TRAIN_SAMPLE_INTERVAL=(0 16000000)
...
SAVE_MODEL_PATH=my-sample-model-pldrllm-v510
SAVE_TYPE="torch"
DEVICE='cuda'
logfile=$( realpath "../../../train-logs/${SAVE_MODEL_PATH}.log" )
runfile=$( realpath "../dist_pldr_v510Gi_train_main.py" )
