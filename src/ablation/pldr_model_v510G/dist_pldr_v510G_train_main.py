'''
Main script for distributed training of PLDR-LLM v510G
'''
...
import pldr_run_model_v510G as pldr_run_model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gcachelst', type=str, default='my_gcachelst_file.pkl', metavar='GCACHE-FILE',
                        help='MODEL PARAM: Path to pickle file with gcache list for v510G version of a v510 '+ 
                        'pldr model (Default: my_gcachelst_file.pkl)')
