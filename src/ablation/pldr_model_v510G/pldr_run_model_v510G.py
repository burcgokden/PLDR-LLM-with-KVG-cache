'''
LLM from Power Law Decoder Representations v510G (PLDR-LLM v510G) with KV-cache and G-cache
...
from pldr_model_v510G import (plgMultiHeadAttention, PLDR_DecoderLayer, PLDR_Model,
                                 PLDR_Decoder, GLUVariant)
from power_law_attention_layer_v510G import plga_layer

import pldr_model_v510G as pldr_model
import common as cm
...
class dist_pldr_model_e2e:
    ...
    def __init__(self, rank, world_size, inp_obj_src, hpdict=None,
        ...
        if hpdict:
            ...
            self.hpdict={"num_layers": 5,
                         ...
                         "Gcachelst": None, #a pickle file to load gcache file.
        ...
        self.Gcachelst=cm.pklload(self.hpdict["Gcachelst"])
    ...
    def dist_train_step(self, inp):
        ...
        with torch.autocast(device_type='cuda', dtype=torch.bfloat16, enabled=self.use_amp):
            ...
            predictions, _, _ = self.dist_pldr_model([tar_inp, combined_mask], kvcachelst=None)
    ...
    def generate_text(self, sentence, 
        ...
        for i in range(max_length):
            ...
            predictions, _, kvcachelst_nxt  = self.pldr_model([seq_in, combined_mask],
